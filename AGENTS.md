...
**Built-in**: Claude Opus 4.6 (`opus-4.6-chat`, `opus-4.6-coder`), Claude Opus 4.8 (`opus-4.8-chat`, `opus-4.8-coder`), GPT-5.3-Codex (`gpt-5.3-codex-chat`, `gpt-5.3-codex-coder`), GPT-5.4 (`gpt-5.4-chat`, `gpt-5.4-coder`), GPT-5.5 (`gpt-5.5-chat`, `gpt-5.5-coder`), GPT-5.4 ChatGPT (`gpt-5.4-chatgpt-chat`, `gpt-5.4-chatgpt-coder`), GPT-5.5 ChatGPT (`gpt-5.5-chatgpt-chat`, `gpt-5.5-chatgpt-coder`), GPT-5.4 Fast ChatGPT (`gpt-5.4-chatgpt-fast-chat`, `gpt-5.4-chatgpt-fast-coder`), GPT-5.5 Fast ChatGPT (`gpt-5.5-chatgpt-fast-chat`, `gpt-5.5-chatgpt-fast-coder`), Gemini 3.1 Pro (`gemini-3.1-pro-chat`), Gemini 3 Flash (`gemini-3-flash-chat`). Built-in personas include the **default** subagent (general-purpose, trigger: explicit) unless it is explicitly disabled. Built-in personas have `skills: "*"` to enable all discovered skills by default. See trigger sensitivity below for how subagent and skill activation is controlled.
