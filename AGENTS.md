...
- `tau async --project <id> <prompt...> | <prompt...> | -- <prompt...> | list | status <id> | logs <id> | send <id> <text...> | cancel <id>` - Async client commands (`<prompt...>` uses `async.client.defaultProjectId` when set)
