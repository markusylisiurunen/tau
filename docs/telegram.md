...
- Changing the configured directory does not migrate existing sessions. Recovery fails if a session's durable execution directory differs from the current project directory.
