    ...
    try {
      ...
      writeFileSync(
        ...
        [
          ...
          "const sampleInput: TauSdkSessionSampleInput = { context: { systemPrompt: 'system', messages: [{ role: 'system', content: 'instruction', timestamp: 1, metadata: { type: 'instruction', version: 1 } }] }, options: {} };",
